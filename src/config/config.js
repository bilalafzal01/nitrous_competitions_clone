...
const grayColorSecondary = "#756f7e";
const textGray2 = "#3C4B64";
const linen = "#f7f3ea";
const midNightBlue = "#0a2a66";
const sidebarGrayColor = "#a6a6a6";
const turqoise = "#03cad2";
const correctBgColor = "#f6ffed";
const incorrectBgColor = "#f5e7e8";
...
const theme = {
  ...
  // Custom colors:
  "dc-green": "#44ef62",
  "gray-color-secondary": grayColorSecondary,
  "text-gray-2": textGray2,
  linen: linen,
  "mid-night-blue": midNightBlue,
  "sidebar-gray-color": sidebarGrayColor,
  turqoise: turqoise,
  "correct-bg-color": correctBgColor,
  "incorrect-bg-color": incorrectBgColor,
};

const config = {
  theme,
  API_BASE_URL: `http://localhost:5000`,
  // API_BASE_URL: `http://192.168.18.43:5000`
};
